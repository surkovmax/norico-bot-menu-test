...
DISHES = [
    ...
    {"cat": "drinks", "name": "Strawberry Lemonade", "price": "7,50 €",
     "ingredients": "Strawberry purée, grapefruit soda", "allergens": [],
     "serving1": "трубочка, подставка",
     "serving2": "трубочка, подставка", "position": "side"},
...
def generate_quiz() -> list:
    ...
    # напитки с заполненным составом, исключая кофейные позиции
    COFFEE_EXCLUSIONS = {
        "Espresso", "Americano", "Cappuccino", "Latte", "Flat White",
        "Chai Latte", "Double Espresso", "Iced Latte", "Iced Chai Latte",
    }
    drinks_with_ingr = [
        d for d in DISHES
        if d["cat"] == "drinks" and d["ingredients"] and d["name"] not in COFFEE_EXCLUSIONS
    ]
